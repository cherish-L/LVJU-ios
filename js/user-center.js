$(function() {
	...
	//我的收藏弹框
	$(".user-center-section .collection").on("tap",function() {
	...
	$(".personal-collection-pushheader .return").on("tap",function() {
		$(".personal-collection-push").css("transform", "translateX(" + setw + "px)")
		$(".user-center-shadow").fadeOut(250)
	})

	//我的足迹弹框
	$(".user-center-section .footprint").on("tap",function() {
		if($(".user-center-container .Not-logged").hasClass("show")) {
			clearTimeout(please_login)
			$(".user-center-container .message-prompt").css("display", "none")
			$(".set-up-pushsection .login-box").css("display", "none")
	...
	$(".personal-footprint-pushheader .return").on("tap",function() {
		$(".personal-footprint-push").css("transform", "translateX(" + setw + "px)")
		$(".user-center-shadow").fadeOut(250)
	})

	//我的消息弹框
	$(".user-center-section .news").on("tap",function() {
		if($(".user-center-container .Not-logged").hasClass("show")) {
			clearTimeout(please_login)
			$(".user-center-container .message-prompt").css("display", "none")
			$(".set-up-pushsection .login-box").css("display", "none")
	...
	$(".personal-news-pushheader .return").on("tap",function() {
		$(".personal-news-push").css("transform", "translateX(" + setw + "px)")
		$(".user-center-shadow").fadeOut(250)
	})

	//我的优惠券弹框
	$(".user-center-section .Coupon").on("tap",function() {
		if($(".user-center-container .Not-logged").hasClass("show")) {
			clearTimeout(please_login)
			$(".user-center-container .message-prompt").css("display", "none")
			$(".set-up-pushsection .login-box").css("display", "none")
	...
	$(".personal-coupon-pushheader .return").on("tap",function() {
	...
	$(".set-up-pushheader .return").on("tap",function() {
	...
	$(".set-up-pushsection .message-management").on("tap",function() {
		$(".message-management-push").css("transform", "translateX(0px)")
		$(".set-up-shadow").fadeIn(250)
	})

	$(".message-management-pushheader .return").on("tap",function() {
	...
	$(".set-up-pushsection .about-us").on("tap",function() {
		$(".about-us-push").css("transform", "translateX(0px)")
		$(".set-up-shadow").fadeIn(250)
	})
	$(".about-us-pushheader .return").on("tap",function() {
	...
	$(".set-up-pushsection .help-description").on("tap",function() {
		$(".help-description-push").css("transform", "translateX(0px)")
		$(".set-up-shadow").fadeIn(250)
	})
	$(".help-description-pushheader .return").on("tap",function() {
	...
	$(".help-description-push .how-register").on("tap",function() {
		$(".how-register-push").css("transform", "translateX(0px)")
		$(".help-description-shadow").fadeIn(250)
	})

	$(".how-register-pushheader .return").on("tap",function() {
	...
	$(".set-up-push .feedback").on("tap",function() {
		$(".feedback-push").css("transform", "translateX(0px)")
		$(".set-up-shadow").fadeIn(250)
	})

	$(".feedback-pushheader .return").on("tap",function() {
	...
	//登录点击显示密码
	$(".login-page-pushsection .login-page-Password .showPassword").on("tap",function() {
	...
	//注册点击显示密码
	$(".login-page-pushsection .registered-Password .showPassword").on("tap",function() {
	...
	$(".retrieve-password-push .retrieve-new a").on("tap",function() {
	...
	$(".retrieve-password-pushsection .retrieve-p").bind('input propertychange', function() {
		...
		if((/^1[3|4|5|8]\d{9}$/.test(this_ipt_retrieve))) {
			...
			if($(".retrieve-password-pushsection .Verificationbtn").hasClass("light")) {
				$(".retrieve-password-pushsection .Verificationbtn").on("tap",function() {
					$(".retrieve-password-pushsection .Verificationbtn-box-wrapper .tap").css("display", "block")
					...
					$(document).ready(function() {
						...
						setTime_retrieve = setInterval(function() {
							if(time <= 0) {
								...
								$(".retrieve-password-pushsection .Verificationbtn-box-wrapper .tap").css("display", "none")
							}
							if(time > 0) {
	...
	//修改密码失败
	var retrievenum = 0;
	$(".retrieve-password-pushsection .retrieve-btn").on("tap",function() {
	...
	//点击忘记密码
	$(".login-page-pushsection .login-page-way .forgot-password").on("tap",function() {
		$(".retrieve-password-push").css("transform", "translateX(0px)")
		$(".login-page-shadow").fadeIn(250)
	})
	$(".retrieve-password-pushheader .return").on("tap",function() {
		$(".retrieve-password-push").css("transform", "translateX(" + setw + "px)")
		$(".login-page-shadow").fadeOut(250)
	})

	//点击登录账号
	$(".login-page-pushsection .account-login .login-page-btn").on("tap",function() {
	...
	$(".login-page-phone .Userphone").bind('input propertychange', function() {
		...
		if((/^1[3|4|5|8]\d{9}$/.test(this_ipt))) {
			...
			$(".login-page-phone .Verificationbtn").on("tap",function() {
				if($(this).hasClass("light") && (/^1[3|4|5|8]\d{9}$/.test(this_ipt))) {
					$(".login-page-phone .Verificationbtn-box-wrapper .tap").css("display", "block")
					...
					$(document).ready(function() {
						...
						setTime_login = setInterval(function() {
							if(time <= 0) {
								...
								$(".login-page-phone .Verificationbtn-box-wrapper .tap").css("display", "none")
							}
							if(time > 0) {
	...
	$(".account-login .dynamic-login").on("tap",function() {
		$(".phone-dynamic-login").fadeIn()
		$(".account-login").fadeOut(0)
		$(".registered-account").fadeOut(0)
		$(".login-page-pushheader .title_txt").addClass("show")
	})
	$(".phone-dynamic-login .dynamic-login").on("tap",function() {
	...
	$(".login-page-pushheader .register").on("tap",function() {
	...
	$(".login-page-pushheader .login").on("tap",function() {
	...
	var settime = null;
	$('.phone-dynamic-login .login-page-btn').on("tap",function() {
	...
	$(".user-center-section .Not-logged").on("tap",function() {
		$(".login-page-push").css("transform", "translateX(0px)")
		$(".user-center-shadow").fadeIn(250)
	})

	$(".login-page-pushheader .return").on("tap",function() {
		$(".login-page-push").css("transform", "translateX(" + setw + "px)")
		$(".user-center-shadow").fadeOut(250)
	...
	$(".registered-phone .Userphone").bind('input propertychange', function() {
		...
		if((/^1[3|4|5|8]\d{9}$/.test(this_ipt_register))) {
			...
			$(".registered-phone .Verificationbtn").on("tap",function() {
				if($(".registered-phone .Verificationbtn").hasClass("light")) {
					$(".registered-phone .Userphone").blur()
					$(".registered-phone .Verificationbtn-box-wrapper .tap").css("display", "block")
					...
					$(document).ready(function() {
						...
						setTime_registered = setInterval(function() {
							if(time <= 0) {
								...
								$(".Verificationbtn-box-wrapper .tap").css("display", "none")
							}
							if(time > 0) {
	...
	$(".registered-account input").bind('input propertychange', function() {
		$(".registered-account .registered-btn").on("tap",function() {
			if((/^1[3|4|5|8]\d{9}$/.test(inputU.val())) && inputV.val() !== "" && inputP.val() !== "") {
				...
				$(".register-state-pushheader .return").on("tap",function() {
					$(".register-state-push").css("transform", "translateX(" + setw + "px)")
					$(".login-page-shadow").fadeOut(250)
				})

				$(".register-fail-box .Re-registration").on("tap",function() {
	...
	$(".user-center-section .Logged-in").on("tap",function() {
		$(".personal-data-push").css("transform", "translateX(0px)")
		$(".user-center-shadow").fadeIn(250)
	})
	$(".personal-data-pushheader .return").on("tap",function() {
	...
	$(".personal-data-pushsection .account-name").on("tap",function() {
		...
		$(".account-name-pushheader .return").on("tap",function() {
			$(".account-name-push").css("transform", "translateX(" + setw + "px)")
			$(".personal-data-shadow").fadeOut(250)
			$(".account-name-pushsection .accountName").val(Aname)
		})

		$(".account-name-pushheader .save").on("tap",function() {
	...
	$(".account-name-pushsection .delete").on("tap",function() {
	...
	$(".personal-data-pushsection .nickname").on("tap",function() {
		...
		$(".nickname-pushheader .return").on("tap",function() {
			$(".nickname-push").css("transform", "translateX(" + setw + "px)")
			$(".personal-data-shadow").fadeOut(250)
			$(".nickname-pushsection .nickName").val(Aname)
		})

		$(".nickname-pushheader .save").on("tap",function() {
	...
	$(".nickname-pushsection .delete").on("tap",function() {
	...
	$(".personal-data-pushsection .real-name").on("tap",function() {
		...
		$(".real-name-pushheader .return").on("tap",function() {
			$(".real-name-push").css("transform", "translateX(" + setw + "px)")
			$(".personal-data-shadow").fadeOut(250)
			$(".real-name-pushsection .realName").val(Aname)
		})

		$(".real-name-pushheader .save").on("tap",function() {
	...
	$(".real-name-pushsection .delete").on("tap",function() {
	...
	$(".personal-data-pushsection .account-management .Modify-password").on("tap",function() {
		$(".modify-password-push").css("transform", "translateX(0px)")
		$(".personal-data-shadow").fadeIn(250)
	})
	$(".modify-password-pushheader .del").on("tap",function() {
		$(".modify-password-push").css("transform", "translateX(" + setw + "px)")
		$(".personal-data-shadow").fadeOut(250)
	})

	var modify = 0;
	$(".modify-password-pushsection .modify-btn").on("tap",function() {
	...
	//点击显示新密码
	$(".modify-password-box .new-password a").on("tap",function() {
	...
	$(".personal-data-pushsection .gender").on("tap",function() {
		$(".personal-data-Mask").addClass("show")
		...
		$(".gender-push li").on("tap",function() {
			var litxt = $(this).text()
			var index = $(this).index()
			$(this).addClass("select").siblings().removeClass("select")
	...
	$(".personal-data-pushsection .bind_mailbox .btn").on("tap",function() {
		...
		$(".modify-mailbox-pushheader .return").on("tap",function() {
			$(".modify-mailbox-push").css("transform", "translateX(" + setw + "px)")
			$(".personal-data-shadow").fadeOut(250)
			$(".modify-mailbox-pushsection .mailbox").val(b_m)
		})

		$(".modify-mailbox-pushheader .save").on("tap",function() {
	...
	$(".modify-mailbox-pushsection .delete").on("tap",function() {
	...
	$(".personal-data-pushsection .bind_weixin .btn").on("tap",function() {
		...
		$(".weixin-pushheader .return").on("tap",function() {
			$(".weixin-push").css("transform", "translateX(" + setw + "px)")
			$(".personal-data-shadow").fadeOut(250)
			$(".weixin-pushsection .weixin").val(b_w)
		})

		$(".weixin-pushheader .save").on("tap",function() {
	...
	$(".weixin-pushsection .delete").on("tap",function() {
	...
	$(".personal-data-pushsection .bind_phone .btn").on("tap",function() {
	...
	$(".pc_phone-pushsection .delete").on("tap",function() {
   ...
   $('.personal-footprint-pushsection .Pfootprint-data-li .dataDetail').bind("touchstart",function(e){//点击其他的自动收回删除键
	...
	//用户中心--我的消息--消息详情
	$(".personal-news-data .personal-news-datali .receiveNews-time-li").on("tap",function() {
		$(".news-detail-push").css("transform", "translateX(0px)")
		$(".personal-news-shadow").fadeIn(250)
	})
	$(".news-detail-pushheader .return").on("tap",function() {
	...
	$(".personal-coupon-push .coupon-nav-li").on("tap",function() {
		var index = $(this).index()
		$(this).addClass("select").siblings().removeClass("select")
	...
	$(".personal-coupon-pushfooter").on("tap",function() {
		$(".using-tutorials-push").css("transform", "translateX(0px)")
		$(".personal-coupon-shadow").fadeIn(250)
	})
	$(".using-tutorials-pushheader .return").on("tap",function() {
	...
	$(".personal-coupon-push .notUsed").on("tap",function() {
		//获取优惠券数据
	...
	$(".coupon-details-pushheader .return").on("tap",function() {
	...
	$(".personal-coupon-push .alreadyUsed").on("tap",function() {
		//获取优惠券数据
		var dataTitle = $(this).find(".hide_data .dataTitle").html()
		var dataDetailed = $(this).find(".hide_data .dataDetailed").html()
		var dataCode = $(this).find(".hide_data .dataCode").html()
	...
	$(".personal-coupon-push .overdue").on("tap",function() {
		//获取优惠券数据
		var dataTitle = $(this).find(".hide_data .dataTitle").html()
		var dataDetailed = $(this).find(".hide_data .dataDetailed").html()
		var dataCode = $(this).find(".hide_data .dataCode").html()
	...
	$(".lookup-coupon-pushsection .input-wrapper .lookup_ipt").bind('input propertychange', function() {
		...
		$(".lookup-coupon-pushsection .lookup-coupon-btn").on("tap",function() {
			...
			if(_lookupindex.val() !== "" || _lookupindex.val() == "123456") {
				...
				//点击查找的优惠券弹出优惠券详情
				$(".personal-coupon-push .lookup-coupon-push .lookup-coupon-results .notUsed").on("tap",function() {
					//获取优惠券数据
					var dataTitle = $(this).find(".hide_data .dataTitle").html()
					var dataDetailed = $(this).find(".hide_data .dataDetailed").html()
					var dataCode = $(this).find(".hide_data .dataCode").html()
	...
	$(".lookup-coupon-pushsection .input-wrapper a").on("tap",function() {
	...
	$(".personal-coupon-pushheader .lookup").on("tap",function() {
		$(".lookup-coupon-push").css("transform", "translateX(0px)")
		$(".personal-coupon-shadow").fadeIn(250)
	})
	$(".lookup-coupon-pushheader .return").on("tap",function() {
